...
export type packageWeightProps = {
  id: number;
  type: string;
};
...
export const acceptedBanks: BankAccountType[] = [
  { id: 1, bankname: "Gurantee Trust Bank" },
  { id: 2, bankname: "First Bank" },
  { id: 3, bankname: "United Bank Of Africa" },
  { id: 4, bankname: "Zenith Bank" },
  { id: 5, bankname: "Access Bank" },
];

export const vehicleTypes: vehicleTypeProp[] = [
  { id: 1, type: "Bicycle" },
  { id: 2, type: "Motocycle" },
  { id: 3, type: "Car" },
  { id: 4, type: "Van" },
...
export const packageWeight: packageWeightProps[] = [
  { id: 1, type: "5 kg" },
  { id: 2, type: "10 kg" },
  { id: 3, type: "20 kg" },
  { id: 4, type: "50 kg" },
...
export const packageType: packageTypeProps[] = [
  { id: 1, type: "Document" },
  { id: 2, type: "Package" },
  { id: 3, type: "Food" },
  { id: 4, type: "Fragile" },
