            ...
            <section className="bg-white rounded-2xl md:rounded-[28px] border border-neutral200 p-4 sm:p-6 md:p-8 shadow-sm flex flex-col justify-center">
              ...
              {!isLoading && !isVerified && (
                <div className="py-6">
                  ...
                  <h2 className="mt-5 sm:mt-6 text-2xl sm:text-3xl font-clash font-semibold text-neutral600 text-center">
                    We couldn&apos;t verify this account
                  </h2>
                  <p className="mt-3 text-sm sm:text-base text-neutral500 leading-6 sm:leading-7 text-center max-w-md mx-auto">
